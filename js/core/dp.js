...
(function (global) {
    ...
    DP.config = {
        ...
        morph: {
            ...
            cloudMix: 0.9,         // 0 — частица держится высоты/радиуса своей пары, 1 — случайная точка кольца
            ...
            dustAlpha: 0.2,        // яркость нестянутой пыли относительно частиц в структурах
