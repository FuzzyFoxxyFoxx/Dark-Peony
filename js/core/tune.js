...
(function (DP) {
    ...
    DP.tuneSpec = DP.tuneSpec || [
        ...
        ['@vision.gapMin', 'пауза между сеансами: от, с', 0.5, 60, 0.5],
        ['@vision.gapMax', 'пауза: до, с', 1, 90, 0.5],
        ['@vision.durMin', 'сеанс: от, с', 0.5, 10, 0.1],
        ['@vision.durMax', 'сеанс: до, с', 0.5, 15, 0.1],
        ['@vision.density', 'плотность (× рамок)', 0.2, 3, 0.05],
        ['@vision.medium', 'доля средних сеансов', 0, 1, 0.01],
        ['@vision.burst', 'доля всплесков', 0, 1, 0.01],
