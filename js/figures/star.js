...
(function (DP) {
    ...
    const ORBITS = [
        { R: 2.01, incl: 0.10, node: 0.4, phase: 0.6, omega: 0.21,
    ...
    const ATOMS = [
        { R: 1.0,  incl: 0.35,  node: 0.0, phase: 0.3, omega: 0.95,  n: 3, r: 0.027 },
        { R: 1.18, incl: 1.15,  node: 1.3, phase: 1.9, omega: -0.72, n: 2, r: 0.032 },
        { R: 1.36, incl: -0.95, node: 2.5, phase: 4.1, omega: 0.6,   n: 3, r: 0.024 },
        { R: 1.54, incl: 1.45,  node: 3.8, phase: 5.2, omega: -0.5,  n: 2, r: 0.03 }
    ];
    ...
    const DEFAULT_PARTS = 'star,atoms,planet1,planet2,planet3,planet4'; // светило + «атом» (утверждены) + планеты по одной (planet1…planet4)
